...
-spec get_body(Req) -> {ok, binary(), Req} | {error, oas_server:error_reason()} when Req::cowboy_req:req().
get_body(Req) ->
    get_body(Req, #{}).

-spec get_body(Req, cowboy_req:read_body_opts()) -> {ok, binary(), Req} | {error, oas_server:error_reason()} when Req::cowboy_req:req().
get_body(Req, Opts) ->
...
-spec get_operation_id(cowboy_req:req(), oas_server_router:init_opts()) -> oas_server:operation_id() | undefined.
